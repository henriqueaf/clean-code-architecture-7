export default class Cpf {
  private static DIGIT_1_FACTOR = 10;
  private static DIGIT_2_FACTOR = 11;
  ...
  validate (cpf: string) {
    ...
    const digit1 = this.calculateDigit(cpf, Cpf.DIGIT_1_FACTOR);
    const digit2 = this.calculateDigit(cpf, Cpf.DIGIT_2_FACTOR);
